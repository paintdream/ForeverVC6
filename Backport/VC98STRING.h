...
_CRTIMP void __cdecl _Xran();
		// TEMPLATE CLASS basic_string_mt
template<class _E,
	class _Tr = char_traits<_E>,
	class _A = allocator<_E> >
	class basic_string_mt {
public:
	typedef basic_string_mt<_E, _Tr, _A> _Myt;
	...
	basic_string_mt(const _Myt& _X, size_type _P, size_type _M,
		const _A& _Al = _A())
		: allocator(_Al) {_Tidy(), assign(_X, _P, _M); }
	basic_string_mt(const _E *_S, size_type _N,
		const _A& _Al = _A())
		: allocator(_Al) {_Tidy(), assign(_S, _N); }
	basic_string_mt(const _E *_S, const _A& _Al = _A())
		: allocator(_Al) {_Tidy(), assign(_S); }
	basic_string_mt(size_type _N, _E _C, const _A& _Al = _A())
		: allocator(_Al) {_Tidy(), assign(_N, _C); }
	typedef const_iterator _It;
	basic_string_mt(_It _F, _It _L, const _A& _Al = _A())
...
private:
	...
	void _Copy(size_type _N)
		...
		_E *_S;
		_TRY_BEGIN
			_S = allocator.allocate(_Ns + 1, (void *)0);
		_CATCH_ALL
			_Ns = _N;
			_S = allocator.allocate(_Ns + 1, (void *)0);
		_CATCH_END
		if (0 < _Len)
			_Tr::copy(_S, _Ptr,_Len>_Ns?_Ns:_Len);
	...
	void _Tidy(bool _Built = false)
		{if (!_Built || _Ptr == 0)
			...
			allocator.deallocate(_Ptr, _Res + 1);
		_Ptr = 0, _Len = 0, _Res = 0; }
	_E *_Ptr;
	size_type _Len, _Res;
	};
template<class _E, class _Tr, class _A>
	const basic_string_mt<_E, _Tr, _A>::size_type
		basic_string_mt<_E, _Tr, _A>::npos = -1;

#ifdef	_DLL
#pragma warning(disable:4231) /* the extern before template is a non-standard extension */

extern template class _CRTIMP basic_string_mt<char, char_traits<char>, allocator<char> >;
extern template class _CRTIMP basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >;

#pragma warning(default:4231) /* restore previous warning */
#endif		// _DLL

typedef basic_string_mt<char, char_traits<char>, allocator<char> >
	string_mt;

typedef basic_string_mt<wchar_t, char_traits<wchar_t>,
	allocator<wchar_t> > wstring_mt;
...
#endif  /* _MSC_VER */
_STD_BEGIN
        // basic_string_mt TEMPLATE OPERATORS
template<class _E, class _Tr, class _A> inline
    basic_string_mt<_E, _Tr, _A> __cdecl operator+(
        const basic_string_mt<_E, _Tr, _A>& _L,
        const basic_string_mt<_E, _Tr, _A>& _R)
    {return (basic_string_mt<_E, _Tr, _A>(_L) += _R); }
template<class _E, class _Tr, class _A> inline
    basic_string_mt<_E, _Tr, _A> __cdecl operator+(const _E *_L,
        const basic_string_mt<_E, _Tr, _A>& _R)
    {return (basic_string_mt<_E, _Tr, _A>(_L) += _R); }
template<class _E, class _Tr, class _A> inline
    basic_string_mt<_E, _Tr, _A> __cdecl operator+(
        const _E _L, const basic_string_mt<_E, _Tr, _A>& _R)
    {return (basic_string_mt<_E, _Tr, _A>(1, _L) += _R); }
template<class _E, class _Tr, class _A> inline
    basic_string_mt<_E, _Tr, _A> __cdecl operator+(
        const basic_string_mt<_E, _Tr, _A>& _L,
        const _E *_R)
...
template<class _E, class _Tr, class _A> inline
    basic_string_mt<_E, _Tr, _A> __cdecl operator+(
        const basic_string_mt<_E, _Tr, _A>& _L, const _E _R)
    {return (basic_string_mt<_E, _Tr, _A>(_L) += _R); }
template<class _E, class _Tr, class _A> inline
    bool __cdecl operator==(const basic_string_mt<_E, _Tr, _A>& _L,
        const basic_string_mt<_E, _Tr, _A>& _R)
...
template<class _E, class _Tr, class _A> inline
    bool __cdecl operator>=(const basic_string_mt<_E, _Tr, _A>& _L,
        const _E *_R)
    {return (!(_L < _R)); }
        // basic_string_mt INSERTERS AND EXTRACTORS
template<class _E, class _Tr, class _A> inline
    basic_istream<_E, _Tr>& __cdecl operator>>(
        basic_istream<_E, _Tr>& _I,
        basic_string_mt<_E, _Tr, _A>& _X)
...
template<class _E, class _Tr, class _A> inline
    basic_istream<_E, _Tr>& __cdecl getline(basic_istream<_E, _Tr>& _I,
        basic_string_mt<_E, _Tr, _A>& _X, const _E _D)
    {typedef basic_istream<_E, _Tr> _Myis;
    ios_base::iostate _St = ios_base::goodbit;
    bool _Chg = false;
    _X.erase();
...
template<class _E, class _Tr, class _A> inline
    basic_ostream<_E, _Tr>& __cdecl operator<<(
        ...
        const basic_string_mt<_E, _Tr, _A>& _X)
    {
    _O << _X.c_str();
    return (_O); }
...
extern template class _CRTIMP
    basic_string_mt<char, char_traits<char>, allocator<char> > __cdecl operator+(
        const basic_string_mt<char, char_traits<char>, allocator<char> >&,
        const basic_string_mt<char, char_traits<char>, allocator<char> >&);
extern template class _CRTIMP
    basic_string_mt<char, char_traits<char>, allocator<char> > __cdecl operator+(
        const char *, const basic_string_mt<char, char_traits<char>, allocator<char> >&);
extern template class _CRTIMP
    basic_string_mt<char, char_traits<char>, allocator<char> > __cdecl operator+(
        const char, const basic_string_mt<char, char_traits<char>, allocator<char> >&);
extern template class _CRTIMP
    basic_string_mt<char, char_traits<char>, allocator<char> > __cdecl operator+(
        const basic_string_mt<char, char_traits<char>, allocator<char> >&, const char *);
extern template class _CRTIMP
    basic_string_mt<char, char_traits<char>, allocator<char> > __cdecl operator+(
        const basic_string_mt<char, char_traits<char>, allocator<char> >&, const char);
...
extern template class _CRTIMP
    basic_istream<char, char_traits<char> >& __cdecl operator>>(
        ...
        basic_string_mt<char, char_traits<char>, allocator<char> >&);
extern template class _CRTIMP
...
extern template class _CRTIMP
    basic_istream<char, char_traits<char> >& __cdecl getline(
        basic_istream<char, char_traits<char> >&,
        basic_string_mt<char, char_traits<char>, allocator<char> >&, const char);
extern template class _CRTIMP
...
extern template class _CRTIMP
    basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> > __cdecl operator+(
        const basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&,
        const basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&);
extern template class _CRTIMP
    basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> > __cdecl operator+(
        const wchar_t *, const basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&);
extern template class _CRTIMP
    basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> > __cdecl operator+(
        const wchar_t, const basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&);
extern template class _CRTIMP
    basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> > __cdecl operator+(
        const basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&, const wchar_t *);
extern template class _CRTIMP
    basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> > __cdecl operator+(
        const basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&, const wchar_t);
extern template _CRTIMP bool __cdecl operator==(
...
extern template class _CRTIMP
    basic_istream<wchar_t, char_traits<wchar_t> >& __cdecl operator>>(
        ...
        basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&);
extern template class _CRTIMP
...
extern template class _CRTIMP
    basic_istream<wchar_t, char_traits<wchar_t> >& __cdecl getline(
        basic_istream<wchar_t, char_traits<wchar_t> >&,
        basic_string_mt<wchar_t, char_traits<wchar_t>, allocator<wchar_t> >&, const wchar_t);
extern template class _CRTIMP
